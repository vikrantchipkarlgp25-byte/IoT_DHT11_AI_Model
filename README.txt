...
The Wemos D1 Mini (ESP8266) sends sensor data to the backend via the RobotNinja API.

The backend processes incoming data and predicts the current environmental condition.

A simple AI-based logic classifies the environment and generates recommendations.
...
Multiple devices can send data to the same system simultaneously.
...
or deploy using GitHub Pages or any free hosting service
...
GitHub Repository:
https://github.com/vikrantchipkarlgp25-byte/IoT_DHT11_AI_Model.git

Web Dashboard:
https://vikrantchipkarlgp25-byte.github.io/IoT_DHT11_AI_Model/

Mobile App (.aia file):
https://x.thunkable.com/projectPage/68f47e6ad2117f94eaa50e1c
